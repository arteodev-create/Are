...
export function VerifiedBadgeIcon({ size = 18 }) {
  return (
    <svg className="verified-badge-icon" width={size} height={size} viewBox="0 0 22 22" aria-hidden="true" focusable="false">
...
export function VerifiedName({ children, verified = false }) {
  return (
    <span className="verified-name">
      <span>{children}</span>
      {verified && <VerifiedBadgeIcon size={18} />}
    </span>
  );
}
